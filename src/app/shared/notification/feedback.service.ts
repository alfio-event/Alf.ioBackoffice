...
export class FeedbackService {
    ...
    private fallbackIfAndroid(message: string, fn: () => Promise<void>): Promise<void> {
        if (androidApplication) {
            ...
            // we'll fall back to a simple "toast" for now
            ...
            android.widget.Toast.makeText(Utils.android.getApplicationContext(), centeredText.toString(), android.widget.Toast.LENGTH_SHORT).show();
